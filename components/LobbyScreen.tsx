    ...
    <main className="lobby-shell">
      ...
      <div className="lobby-layout">
        ...
        <aside className="lobby-settings">
          ...
          <label className="setting-row"><span><b>Finale Challenge</b><small>Giro corrente, ultimo giro e sdadata</small></span><select disabled={!isHost} value={state.settings.timeLimitMinutes} onChange={(event) => update("timeLimitMinutes", Number(event.target.value))}><option value={90}>90 min · principale</option><option value={60}>60 minuti</option><option value={45}>45 minuti</option><option value={0}>Disattivato</option></select></label>
